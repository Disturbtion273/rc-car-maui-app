...
public class CustomPicker : GraphicsView
{
    ...
    public Color PickerIconColor
    {
        get => (Color)GetValue(PickerIconColorProperty);
        set => SetValue(PickerIconColorProperty, value);
    }
    ...
    {
        _drawable.SelectedText = (Items != null && Items.Count > 0 && SelectedIndex >= 0 && SelectedIndex < Items.Count)
            ? Items[SelectedIndex]
            : "";
