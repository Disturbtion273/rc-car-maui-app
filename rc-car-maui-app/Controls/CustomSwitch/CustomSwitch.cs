...
public class CustomSwitch : GraphicsView
{
    ...
    {
        get => (Color)GetValue(TrackColorOnProperty);
        set => SetValue(TrackColorOnProperty, value);
    }
    ...
    {
        get => (Color)GetValue(TrackColorOffProperty);
        set => SetValue(TrackColorOffProperty, value);
    }

    public static readonly BindableProperty CapsuleColorOnProperty =
        BindableProperty.Create(nameof(CapsuleColorOn), typeof(Color), typeof(CustomSwitch),
            Color.FromArgb("#02ACA3"), propertyChanged: OnAppearanceChanged);

    public Color CapsuleColorOn
    {
        get => (Color)GetValue(CapsuleColorOnProperty);
        set => SetValue(CapsuleColorOnProperty, value);
    }

    public static readonly BindableProperty CapsuleColorOffProperty =
        BindableProperty.Create(nameof(CapsuleColorOff), typeof(Color), typeof(CustomSwitch),
            Color.FromArgb("#019E95"), propertyChanged: OnAppearanceChanged);

    public Color CapsuleColorOff
    {
        get => (Color)GetValue(CapsuleColorOffProperty);
        set => SetValue(CapsuleColorOffProperty, value);
    }
    ...
    void UpdateDrawableFromProperties()
    {
        ...
        _drawable.CapsuleColorOn = CapsuleColorOn;
        _drawable.CapsuleColorOff = CapsuleColorOff;
