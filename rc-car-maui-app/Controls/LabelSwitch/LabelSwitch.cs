...
public class LabelSwitch : GraphicsView
{
    ...
    public static readonly BindableProperty UnselectedTextProperty =
        BindableProperty.Create(nameof(UnselectedText), typeof(string), typeof(LabelSwitch), "KM/H",
    ...
    public static readonly BindableProperty SelectedTextProperty =
        BindableProperty.Create(nameof(SelectedText), typeof(string), typeof(LabelSwitch), "MP/H",
            propertyChanged: OnAppearanceChanged);
    ...
    {
        get => (Color)GetValue(CapsuleColorProperty);
        set => SetValue(CapsuleColorProperty, value);
    }
